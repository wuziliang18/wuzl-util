...
public class PooledHttpClientAdaptor {
	...
	private final static Logger                  logger                          = LoggerFactory.getLogger(PooledHttpClientAdaptor.class);
    ...
    private final static PooledHttpClientAdaptor pooledHttpClientAdaptor         = new PooledHttpClientAdaptor();

    public static PooledHttpClientAdaptor getDefaultPooledHttpClientAdaptor() {
        return pooledHttpClientAdaptor;
    }

    private PooledHttpClientAdaptor(){
        this(PooledHttpClientAdaptor.DEFAULT_POOL_MAX_TOTAL, PooledHttpClientAdaptor.DEFAULT_POOL_MAX_PER_ROUTE,
             PooledHttpClientAdaptor.DEFAULT_CONNECT_TIMEOUT, PooledHttpClientAdaptor.DEFAULT_CONNECT_REQUEST_TIMEOUT,
    ...
    public PooledHttpClientAdaptor(int maxTotal, int maxPerRoute, int connectTimeout, int connectRequestTimeout,
        ...
        httpClient = httpClientBuilder.setConnectionManager(gcm).setDefaultRequestConfig(requestConfig).build();
